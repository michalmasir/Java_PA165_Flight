...
public class FlightRestController {
    ...
    public ResponseEntity<String> postJson(@RequestBody FlightTO flightTO) {
    ...
    public ResponseEntity<String> putJson(@PathVariable Integer id, @RequestBody FlightTO flightTO) {
